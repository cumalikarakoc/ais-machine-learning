...
Blok1_2fs.FitBest <- glm(formula = RisicoStudent ~ WT_Resultaat + InschrijfStatus + 
                           ...
                           SPD_Resultaat, data = Blok1_2.train)

Blok1_2fs.Predict <- predict(Blok1_2fs.FitBest, newdata=Blok1_2.test, type= "class")
Blok1_2fs.Predict <- round(Blok1_2fs.Predict)
confusionMatrix(data=as.factor(Blok1_2fs.Predict), reference=Blok1_2.test_Risico, positive = "1") #0.8547

Blok1_2All.Predict <- predict(Blok1_2.FitAll, newdata=Blok1_2.test)
Blok1_2All.Predict <- round(Blok1_2All.Predict)
confusionMatrix(data=as.factor(Blok1_2All.Predict), reference=Blok1_2.test_Risico, positive = "1") #0.8547
